...
from modules.consts.common import HTTP_AUTH, SERVICE, SPREAD_SHEET_ID
...
def create_new_sheet(
    info: list, spreadsheetID: str = SPREAD_SHEET_ID,
):
    ...
    append_info = (
        ...
        .batchUpdate(
            ...
            body={"valueInputOption": "USER_ENTERED", "data": request_body},
        )
        .execute()
    )
